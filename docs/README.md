...
2) Система должна быть доступна в сети Интернет 24х7 с возможным временем простоя не более 20 минут;
3) Система должна поддерживать стабильную работу при 1000 одновременных зрителей;
...
| QR.002 | *Доспупность* |Система должна быть доступна в сети Интернет 24х7. |
| QR.003 | *Надежность* |Должно быть проведено нагрузочное тестированивание, по результатам которого определена предельная нагрузка Системы. Как результат система должна быть отказоустойчивой при не менее чем 1500 одновременных зрителей.|
